...
async function runTests() {
  console.log('--- RUNNING GET COURSE DETAILS TESTS (JS) ---');
  ...
  const freeLesson = lessons.find((l) => l.title === 'Free Preview Lesson');
  const paidLesson = lessons.find((l) => l.title === 'Paid Exclusive Lesson');
